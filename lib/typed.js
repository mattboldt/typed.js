	  ...
	  _createClass(Typed, [{
	    ...
	    value: function typewrite(curString, curStrPos) {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        if (substr.charAt(0) === '`') {
	          ...
	          if (_this2.allowBulkBackspace) {
	            // As we don't have the "`" character when backspacing,
	            // we need to keep track of the places where we bulk typed something
	            _this2.bulkTypeBreakpoints = _this2.bulkTypeBreakpoints || {};
	            _this2.bulkTypeBreakpoints[curStrPos + numChars] = numChars;
	          }
	        }
	    ...
	    value: function backspace(curString, curStrPos) {
	      ...
	      this.timeout = setTimeout(function () {
	        ...
	        // are bulk backtyping)
	        if (_this4.allowBulkBackspace && _this4.bulkTypeBreakpoints[curStrPos]) {
	          numChars = _this4.bulkTypeBreakpoints[curStrPos];
	          var stringAfterSkip = curString.substring(0, curStrPos);
