...
var Initializer = /*#__PURE__*/function () {
  ...
  _createClass(Initializer, [{
    ...
    function load(self, options, elementId) {
      ...
      self.options = _objectSpread2(_objectSpread2({}, defaults), options);
    ...
    value: function appendAnimationCss(self) {
      ...
      if (document.querySelector("[".concat(cssDataName, "]"))) {
        return;
      }
...
var HTMLParser = /*#__PURE__*/function () {
  ...
  _createClass(HTMLParser, [{
    ...
    function typeHtmlChars(curString, curStrPos, self) {
...
var Typed = /*#__PURE__*/function () {
  ...
  _createClass(Typed, [{
    ...
    value: function backspace(curString, curStrPos) {
      ...
      this.timeout = setTimeout(function () {
        curStrPos = htmlParser.backSpaceHtmlChars(curString, curStrPos, _this4);
...
//# sourceMappingURL=typed.cjs.js.map
